def test_error_types():
    ...
    try:
        int("abc")  # Hardcode the bad value here
    ...
    try:
        ...
        print(my_plants["Orchid"]) # Try to access a key that isn't there
...
def garden_operations():
    """ Function to excectute all the tests errors and print them. """
